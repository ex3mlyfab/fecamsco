            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header pb-0 b-b-secondary">
                        <h5>Fill up Membership Registration form for an aspiring Member</h5>
                    ...
                    <div class="card-body">
                        <form class="form-wizard" id="regForm" action="{{ route('store.member') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="tab">
                                <div class="row">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="first_name" type="text"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="last_name">Last Name<span
                                                class="text-danger">*</span></label>
                                            <input class="form-control input-air-secondary" id="last_name" type="text"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="residential" name="residential_address" value="{{ old('residential_address') }}"
                                                placeholder="Residential Address" required>{{ old('residential_address') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="nok_address">Address of Next of Kin<span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" id="nok" name="nok_address" value="{{ old('nok_address') }}"
                                                placeholder="nok Address" required>{{ old('nok_address') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="file"
                                                        name="passport_photograph" value="{{old('passport_photograph')}}"/>
                                                </div>
                                            </div>
