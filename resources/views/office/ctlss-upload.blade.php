...
@section('content')
                ...
                <div class="card">
                    ...
                    <div class="card-body shadow">
                        <div class="default-according m-b-3" id="accordionclose">
                            <div class="card">
                                <div class="card-header bg-primary-light text-center d-flex justify-content-between" id="heading1">
    ...
    <script>
                    ...
                    buttons: [{
                        ...
                        },
                        {
                            ...
                            customize: function(win) {
                                $(win.document.body)
                                    .css('font-size', '10pt')
                                    .prepend('<h4 class="text-center">CTLS</h4>');
        ...
        window.addEventListener('credit-upload', event => {
    location.reload();
});
