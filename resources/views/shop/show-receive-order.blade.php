                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="{{route('receive-order.process')}}" method="POST">
                                    @csrf
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            <td>{{$loop->index + 1}} <input type="hidden" name="product_id[]" value="{{$item->id}}"></td>
                                            <td>{{$item->productService->name}}</td>
                                            <td>{{$item->quantity}} <input type="hidden" name="cost_price[]" value="{{$item->price}}"></td>
                                            <td> <input class="form-control input-air-secondary" type="number" name="product_qty[]" id="line_qty.{{$item->id}}" required></td>
                                            <td>{{$item->price}}</td>
                                            <td><input class="form-control input-air-secondary" type="number" name="product_selling_price[]" required id="line_proce.{{$item->id}}"></td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label class="witness3_dept">Account Name<span
                                                class="text-danger">*</span></label>
                                        <input class="form-control input-air-secondary" id="witness3_dept"
                                            placeholder="Supplier account Name" type="text"
                                            name="account_name"
                                            value="{{ old('account_name') }}"
                                             />
                                    </div>
                                    <div class="form-group">
                                        <label class="witness3dept">Account Number<span
                                                class="text-danger">*</span></label>
                                        <input class="form-control input-air-secondary" id="witness3dept"
                                            placeholder="Supplier Account Number" type="text"
                                            name="account_number"
                                            value="{{ old('account_number') }}"
                                             />
                                    </div>
                                    <div class="form-group">
                                        <label class="witnes3_dept">Bank Name<span
                                                class="text-danger">*</span></label>
