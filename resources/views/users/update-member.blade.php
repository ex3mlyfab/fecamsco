        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form-wizard" id="regForm" action="{{ route('self-update.store', auth()->user()->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PATCH')
                            <div class="tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary digits" id="telephone"
                                                ...
                                                value="{{ old('telephone') ?? auth()->user()->member->telephone?? " "}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="exampleFormControlInput1"
                                                ...
                                                value="{{ old('department') ?? auth()->user()->member->department ?? " " }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="exampleInputPassword1"
                                                type="text" placeholder="location" value="{{ old('location') ?? auth()->user()->member->location ?? ""}}"
                                                name="location" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="file_no" type="text"
                                                value="{{ old('file_no') ?? auth()->user()->member->file_no ?? ""}}" name="file_no" placeholder="File No"
                                                required />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary digit" id="ippis_no"
                                                ...
                                                value="{{ old('ippis_no')?? auth()->user()->member->ippis_no ?? "" }}"  @if (isset(auth()->user()->member->ippis_no))
                                                    readonly
                                                @endif/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="rank" type="text"
                                                placeholder="Rank" value="{{ old('rank') ?? auth()->user()->member->rank ?? ""}}" name="rank" required/>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="grade" type="text"
                                                value="{{ old('grade') ?? auth()->user()->member->grade?? "" }}" placeholder="Grade" name="grade" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="residential" name="residential_address"
                                                placeholder="Residential Address" required>{{ old('residential_address') ?? auth()->user()->member->residential_address ?? "" }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="permanent" name="permanent_address"
                                                placeholder="Permanent Address" required>{{ old('permanent_address') ?? auth()->user()->member->permanent_address??"" }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="nok"
                                                ...
                                                value="{{ old('next_of_kin')?? auth()->user()->member->next_of_kin?? "" }}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control input-air-secondary" id="nok_relationship"
                                                ...
                                                value="{{ old('nok_relationship') ?? auth()->user()->member->nok_relationship?? ""}}" />
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="nok" name="nok_address" value=""
                                                placeholder="nok Address" required>{{ old('nok_address') ?? auth()->user()->member->nok_address?? "" }}</textarea>
                                        </div>
                                    </div>
                                    @if (!auth()->user()->deductions()->exists())
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control input-air-secondary digit"
                                                    ...
                                                    name="deduction_amount" value="{{ old('deduction_amount') ?? auth()->user()->member->grade  }}"
                                                    min="5000"
                                                     />
                                            </div>
                            ...
                            @if (!auth()->user()->guarantors()->exists())
                            <div class="tab">
                            ...
                            <div class="text-center"><span class="step"></span><span class="step"></span>
                                @if (!auth()->user()->guarantors()->exists())<span
                                    class="step"></span>
